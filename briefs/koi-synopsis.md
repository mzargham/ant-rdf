...
The **koi** field site read through 2 perspectives: the actants, characterized from each. This synopsis gives each frame's reading and where the frames agree or flip; the per-frame briefs and the perspective comparison carry the full detail.

## At a glance

| Perspective | Grounded in | Invariance tracked | Network | Actants read | Characterizations |
| --- | --- | --- | --- | --- | --- |
| Architectural (chief engineer) | protocol-design |  | KOI as constitutive infrastructure | 5 | 5 |
| Ethnographic (Rennie) | participatory-digital-ethnography |  | Building the loop in the field | 6 | 8 |
...
3 actant(s) are characterized in more than one frame.

**They flip**, same actant, different role by frame:

- **Integration teams**: Architectural = Mediator, Ethnographic = Intermediary
- **Members of beneficiary organizations**: Architectural = Intermediary, Ethnographic = Mediator

**They agree**, same role across the frames that read them:

- **Research collaborators**: Mediator

---

_koi: 14 actants · 2 translations · 13 characterizations · 2 perspectives._

---

**See also:** [Reading guide](koi-guide.md) · [Positionality](koi-positionality.md) · [Glossary](koi-glossary.md)
